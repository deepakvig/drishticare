...
<tbody id=CampTableFirst>
				...
				<tr id=CampTableFirst class="selected">		
						...
						<td style="border-right:0px;border-left:0px;">
							...
							<input type=hidden name=RegAgent value=NewDoctor id=RegInputBox>
						</td>
						<td style="border-right:0px;border-left:0px;">
							<div id="RegFormText">Name</div>
						</td>
						<td style="border-right:0px;border-left:0px;">
							<input type=text name=DoctorName id=RegInputBox>
						</td>
					</tr>
									<tr id=CampTableFirst class="selected">		
						<td style="border-right:0px;border-left:0px;">
						...
						<td style="border-right:0px;border-left:0px;">
							<select name=DoctorGender id=RegInputBox>
						...
						<td style="border-right:0px;border-left:0px;">
							<input type=text name=DoctorCity Name id=RegInputBox>
						</td>
						<td style="border-right:0px;border-left:0px;">
						...
						<td style="border-right:0px;border-left:0px;">
							<select name=DoctorState id=RegInputBox>
						...
						<td style="border-right:0px;border-left:0px;">
							<select name=DoctorCountry id=RegInputBox>
					...
					<tr id=CampTableFirst class="selected">
					<td style="border-right:0px;border-left:0px;">
						<br/><a href=javascript:SubmitForm("NewDoctor") id=LoginButton><font color=white size=2>Register Technician</font></a>
						<br/><br/>
					</td>
					<td style="border-right:0px;border-left:0px;">
						<br/><a href=javascript:ResetForm("NewDoctor") id=LoginButton><font color=white size=2>Reset</font></a>
						<br/><br/>
					</td>
					<td style="border:0px;">
					</td>
